  ...
  return (
    <div className="bg-main-blue w-full h-1/2 mt-24">
      <div className="flex flex-col justify-center items-center">
        ...
        >
          <h1 className="text-3xl font-Inter font-semibold text-main-black">
            Effortless Video Creation for Educators
          </h1>
          <h2 className="font-Inter mb-4 text-2xl font-medium">
        ...
        <button
          type="button"
          className="font-Inter h-12 w-44 mb-24 rounded-lg bg-button-blue text-xl font-medium text-main-white"
        >
          Sign Up
        </button>
      </div>
