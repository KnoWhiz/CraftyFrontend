...
const SideBar = () => {
  return (
    <aside className="font-Inter text-lg fixed left-0 top-24 w-48 flex flex-col h-full items-baseline justify-start bg-main-white text-main-black py-10 gap-y-12 pl-8 pr-2">
      <div className="">
